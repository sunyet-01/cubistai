  ...
  const cards = [
    {
      key: 'hub',
      icon: Trophy,
      href: '/editor?prompt=World Cup 2026 themed illustration',
    ...
    },
    {
      key: 'jersey',
      icon: Shirt,
      href: '/editor?prompt=Custom football jersey design, World Cup 2026 style',
    ...
    },
    {
      key: 'poster',
      icon: Palette,
      href: '/editor?prompt=Football tournament poster, World Cup 2026 theme',
    ...
    },
    {
      key: 'coloring',
      icon: Brush,
      href: '/editor?prompt=Black and white coloring page, World Cup 2026 theme',
