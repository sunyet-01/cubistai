...
export function getSettings(): Setting[] {
  return [
    ...
    // ─── AI / OpenRouter ─────────────────────────────────────────────
    {
      ...
      tab: 'ai',
      description:
        'OpenRouter aggregates many image models (Seedream, GPT Image, Nano Banana, FLUX) behind one key. When set, models like bytedance-seed/seedream-4.5 are routed through it.',
    },
    ...
    // ─── AI / Kie ────────────────────────────────────────────────────
    {
      ...
      tab: 'ai',
      description:
        'Kie.ai (ByteDance ecosystem, WeChat/Alipay friendly) aggregates image models like GPT Image, Seedream, Nano Banana. When set, provider/model slugs route through it.',
    },
